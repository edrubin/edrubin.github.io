...
with [Meredith Fowlie](https://www.meredithfowlie.com) and [Reed Walker](https://w-reed-walker.com)
...
#### __Decomposing _the_ Elasticity of Demand: Empirical and Policy Insights from 300 Million Natural Gas Bills__

with [Maximilian Auffhammer](http://www.auffhammer.com)

We harness 300 million residential bills to estimate income- and season-specific own-price elasticities for natural gas. We exploit a service-territory spatial discontinuity and household-specific exogenous time-series variation as sources of identification and estimate a *pooled* demand elasticity of approximately –0.21. However, we show evidence that this elasticity varies substantially across seasons, income groups, and their interaction—from 0.06 to –0.61. This heterogeneity suggests an unexplored, and implementable policy avenue—shifting fixed costs of operation into summer months—that is potentially more efficient and progressive. More generally, we illustrate how "big data" can produce new empirical and policy insights.
