...
Remote sensing^[I'll focus quite a bit on satellite-based <br> remote sensing but will touch on <br> other approaches (drones, monitors, etc.)] is changing the way we "do" enviro economics
...
- [ ] How do we [_fix_ causal inf.]{.purple} when using remotely sensed data? <br> [(Some promising directions; can rely on infeasible solutions.)]{.grey-light .it}
...
[(Reminds me f current conversations around AI/LLMs.)]{.fragment fragment-index=3 .grey-light .it}
...
Recent work suggests a more prevalent and pernicious type of measurement error^[Proctor, Carleton, and Sum (2026) call this type of measurement error [differential measurement error]{.it}.] common to remotely sensed variables.
...
- previously [unobserveable]{.pink} variables,
...
<br>[↳ how will error propogate through causal inf. models?]{.grey-light}
